...
function onTodoStatusChange(checkboxId, labelId, uniqueNo) {
    ...
    let todoObjIndex = todoList.findIndex(function(eachObj) {
        if (eachObj.uniqueNo === uniqueNo) {
            return true;
        } else {
            return false;
        }
    ...
    if (todoList[todoObjIndex].isChecked) {
        todoList[todoObjIndex].isChecked = false;
    } else {
        todoList[todoObjIndex].isChecked = true;
    }
}
